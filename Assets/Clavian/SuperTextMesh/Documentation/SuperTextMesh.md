...
* __BestFitMode.HorizontalAlways__
	Similar to "Always" but text will expand/shrink on the X axis only.
* __BestFitMode.HorizontalOverLimit__
...
* Fixed unneccesary garbage in Unity 2018.4+ (or earlier versions, possibly) during Rebuild()
